...
class WaicTrigger_wp_comment_status_changed extends WaicTrigger {
	...
	public function controlRun( $args = array() ) {
		...
		return array('date' => date_i18n('Y-m-d'), 'time' => date_i18n('H:i:s'), 'waic_comment_id' => $commentId, 'com_status_old' => $oldStatus, 'waic_post_id' => $postId, 'waic_user_id' => $userId, 'obj_id' => $commentId);
	}
}
