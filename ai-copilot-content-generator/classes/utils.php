...
class WaicUtils {
	...
	public static function convertDateTimeToFront( $dt, $full = false ) {
		return self::convertDateTimeFormat($dt, self::getCurrentDateTimeFormatDB() . ( $full ? ':s' : '' ), self::getCurrentDateTimeFormat());
	}
